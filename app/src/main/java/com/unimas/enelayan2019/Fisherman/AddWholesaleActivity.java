...
//    private Boolean checkPick = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productImage = (ImageView) findViewById(R.id.wholesaleImg);
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (pickImage.equals(false)) {
                    Toast.makeText(AddWholesaleActivity.this, "Please upload an image for the product!", Toast.LENGTH_SHORT).show();
                    submitButton.setVisibility(View.VISIBLE);
                    progressBar.setVisibility(View.INVISIBLE);
                } else if (!isCod.isChecked() && !isSelfPickup.isChecked()) {
                    Toast.makeText(AddWholesaleActivity.this, "Please select at least one payment method!", Toast.LENGTH_SHORT).show();
                    submitButton.setVisibility(View.VISIBLE);
                    progressBar.setVisibility(View.INVISIBLE);
                } else if (pCategory.isEmpty()) {
                    Toast.makeText(AddWholesaleActivity.this, "Please select the category", Toast.LENGTH_SHORT).show();
                    submitButton.setVisibility(View.VISIBLE);
                    progressBar.setVisibility(View.INVISIBLE);
                } else if (pName.isEmpty()) {
                    Toast.makeText(AddWholesaleActivity.this, "Please enter your product name!", Toast.LENGTH_SHORT).show();
                    submitButton.setVisibility(View.VISIBLE);
                    progressBar.setVisibility(View.INVISIBLE);
                } else if (pArea.isEmpty()) {
                    Toast.makeText(AddWholesaleActivity.this, "Please enter your selling area!", Toast.LENGTH_SHORT).show();
                    submitButton.setVisibility(View.VISIBLE);
                    progressBar.setVisibility(View.INVISIBLE);
                } else if (amount.isEmpty()) {
                    Toast.makeText(AddWholesaleActivity.this, "Please enter amount available for the product!", Toast.LENGTH_SHORT).show();
                    submitButton.setVisibility(View.VISIBLE);
                    progressBar.setVisibility(View.INVISIBLE);
                } else if (price.isEmpty()) {
                    Toast.makeText(AddWholesaleActivity.this, "Please enter the price for each kilogram!", Toast.LENGTH_SHORT).show();
                    submitButton.setVisibility(View.VISIBLE);
                    progressBar.setVisibility(View.INVISIBLE);
                } else {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        imageFilePath.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                            ...
                            public void onSuccess(Uri uri) {
                                ...
                                Product product = new Product(sId, sImage, sName, sPhone, sAddress, pCategory, pName, price, amount,
                                ...
                                productReference.setValue(product).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                            Toast.makeText(AddWholesaleActivity.this, "Product inserted successfully!", Toast.LENGTH_SHORT).show();
                                            submitButton.setVisibility(View.VISIBLE);
                                            progressBar.setVisibility(View.INVISIBLE);
                                            finish();
                                        } else {
                                            ...
                                            progressBar.setVisibility(View.INVISIBLE);
                                            submitButton.setVisibility(View.VISIBLE);
                                            Toast.makeText(AddWholesaleActivity.this, "Product fail to be inserted. Problem :" + e, Toast.LENGTH_SHORT).show();
                                            finish();
                                        }
    ...
    private void checkAndRequestForPermissions() {
        if (ContextCompat.checkSelfPermission(AddWholesaleActivity.this,
                Manifest.permission.READ_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(AddWholesaleActivity.this, Manifest.permission.READ_EXTERNAL_STORAGE)) {
                Toast.makeText(getApplicationContext(), "Please accept the permission to access your storage", Toast.LENGTH_SHORT).show();
            } else {
                ActivityCompat.requestPermissions(AddWholesaleActivity.this,
    ...
    private void openGallery() {
        CropImage.activity().start(AddWholesaleActivity.this);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                Toast.makeText(AddWholesaleActivity.this, "Possible error occurred is " + e, Toast.LENGTH_SHORT).show();
            }
